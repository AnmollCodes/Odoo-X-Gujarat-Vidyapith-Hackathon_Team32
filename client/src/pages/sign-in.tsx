      ...
      <div className="max-w-md w-full">
        <Card className="shadow-lg border-gray-200">
          <CardHeader className="space-y-1 text-center">
            <CardTitle className="text-2xl font-bold">Sign In to AgriChain</CardTitle>
            <CardDescription>
