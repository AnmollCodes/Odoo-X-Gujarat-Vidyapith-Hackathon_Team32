...
export function FarmerCard({ farmer, user }: FarmerCardProps) {
  return (
    <div className="bg-white rounded-xl overflow-hidden shadow-md border border-gray-100">
      <div className="h-40 bg-gradient-to-r from-primary-500/20 to-primary-600/20 relative">
      ...
      <div className="pt-12 p-6">
        <div className="flex justify-between items-start mb-4">
          <div>
            <h3 className="font-sans font-semibold text-lg text-gray-800">{user?.name || "Farmer"}</h3>
        ...
        <div className="flex space-x-2 mt-6">
          <Button variant="outline" className="flex-1" asChild>
            <Link href={`/farmer/${farmer?.id || 0}`}>View Profile</Link>
          </Button>
